...
class CreditCard:
    ...
    def __int__(self, number, bank, card_property, last_four_number, validity, three_number, holder_name, accountant_bill_date,
                due_date, fixed_account, available_account):
        self.number = number
        self.bank = bank
